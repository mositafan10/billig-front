                ...
                <Layout style={{backgroundColor:"white"}}>
                    ...
                    <Content>
                        <Row style={{overflow:"hidden"}}>
                            <Col xs={0} sm={0} md={0} lg={24} xl={12} xxl={12} style={{textAlign:"center", marginTop:"40px"}}>
                            <img
                                alt = "billlig.com"
                                src = {login}
                            ...
                            <Col xs={24} sm={24} md={24} lg={24} xl={12} xxl={12} style={{display:"flex", justifyContent:"center", alignItems:"center", marginTop:"10px"}}  > 
