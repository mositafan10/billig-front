            ...
            <div>
                ...
                <br/>
                    ...
                    <Col xs={24} sm={24} md={24} lg={6} xl={6} xxl={6} >
                        <Card
                            ...
                            >
                            <h3 style={{paddingBottom:"5px"}}>بهره‌مندی از تخفیفات و فرصت‌های جهانی</h3>
                            <Meta  
                            style={card_style}
                    ...
                    <Card
                            style={{backgroundColor:"aliceblue"}}
                            bordered={false}
                            cover={<img alt="example" src={secure_payment} style={style_icon} />}
                            >
                ...
                <Row gutter={[20, 20]} style={{backgroundColor:"aliceblue", textAlign:"center"}}>
                    ...
                    <Card
                            ...
                            >
                            <h3 style={{paddingBottom:"5px"}}>کسب درآمد با بیلیگ
</h3>
                            <Meta  
                            style={card_style}
                    ...
                    <Card
                            ...
                            >
                            <h3 style={{paddingBottom:"5px"}}>خرید ارزان‌تر نسبت به فروشگاه‌های داخلی</h3>
                            <Meta  
                            style={card_style}
