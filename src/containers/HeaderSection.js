        ...
        <Row style={{padding:"0 20px 0 20px"}}>
          <Col xs={24} sm={24} md={20} lg={20} xl={20} xxl={20}>
              ...
              >
                ...
                >
                  <Dropdown overlay={this.props.isAuthenticated ? this.menu_login : this.menu_logout} trigger={["click"]}>
                    <div>
                      <Button
                        icon={<MenuOutlined />}
                        style={{
            ...
            <Row>
              <Col xs={24} sm={24} md={20} lg={20} xl={20} xxl={20}>
                <Menu style={{borderBottom:"hidden", marginTop:"5px"}} mode="horizontal">
                  <Menu.Item key="1">
                  ...
                  <Col xs={8} sm={8} md={8} lg={0} xl={0} xxl={0} style={{paddingLeft:"10px"}}>
                    <div>
                      ...
                      <Drawer
                        ...
                        >   
                        <div >
                            <Link onClick={this.onClose} to="create-packet"><p>ثبت آگهی</p></Link>
                            <Link onClick={this.onClose} to="orders"><p>کسب در آمد از سفر</p></Link>
                            <p>بلاگ</p>
                        </div>
                        </Drawer>
                    </div>
                  ...
                  <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8} style={{textAlign:"center"}}>
                    ...
                    <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8} style={{textAlign:"right", paddingRight:"15px"}}>
                        ...
                        <div >
                            ...
                            :
                            <div>
                            <Link onClick={this.onClose} to="/login"><p>ورود</p></Link>
