    ...
    <div>
      ...
      <Row>
        ...
        >
          ...
          >
            ...
            شرایط خرید و قیمت پیشنهاد با شما وارد مذاکره می‌شوند. در صورت نهایی
            شدن توافق بین شما و صاحب آگهی شما منتظر می‌مانید تا صاحب آگهی هزینه
            را پرداخت کند. خرید: پس از پرداخت مشتری شما موظفید با انجام هماهنگی،
            کالای مورد نظر را خریده و یا تحویل بگیرید و جزئیات فرآیند را به
            مشتری اطلاع دهید.
          </p>
        </Col>
        <Col xs={1} sm={1} md={1} lg={2} xl={2} xxl={2}></Col>
      ...
      <Row>
        ...
        >
          ...
          >
            پس از خرید در موعد مقرر، شما کالاهای خریداری شده و یا تحویل گرفته را
            به مشتری تحویل می‌دهید و به محض تأیید مشتری هزینه توافق شده به حساب
            شما واریز خواهد شد و می‌توانید از این سفر و سفرهای بعدی خود لذت
            ببرید.
          </p>
        </Col>
        <Col xs={1} sm={1} md={1} lg={2} xl={2} xxl={2}></Col>
