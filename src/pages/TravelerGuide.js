    ...
    >
      ...
      <Row style={{ justifyContent: "center", display: "flex" }}>
        <Col xs={24} sm={24} md={24} lg={12} xl={12}>
          <p>
          هر شخصی که عضو پلتفرم بیلیگ می‌شود، می‌تواند هم <span style={{color:"#067fc8"}}> مسافر </span>و هم <span style={{color:"#ff9a00"}}> بیلیگر </span>باشد.
          </p>
          <h2>
           <span style={{color:"#067fc8"}}> مسافر </span>کیست؟
          </h2>
          <p>
          <span style={{color:"#067fc8"}}> مسافر </span>کسی‌ است که عضو پلتفرم بیلیگ است و در حین سفر خود خدماتی را انجام می‌دهد و در قبال آن پول دریافت می‌کند. 
          </p>
          <h2>خدماتی که یک <span style={{color:"#067fc8"}}> مسافر </span>می‌تواند انجام دهد از این قبیل هستند:</h2>

          <li>
            جابه‌جایی بسته حین سفر:
            <p>
              خیلی افراد هستند که می‌خواهند از ایران به خارج یا بلعکس یک بسته را
              پست کنند. <span style={{color:"#067fc8"}}> مسافر </span>می‌تواند این بسته را از صاحب آن تحویل بگیرد و آن
          ...
          <li>
            ...
            <p>
              ...
              کنید که هزینه خرید + دستمزد <span style={{color:"#067fc8"}}> مسافر </span>از قبل به پلتفرم بیلیگ پرداخت
              می‌شود و تا پایان فرایند خرید و تحویل کالا نزد بیلیگ به‌عنوان
              ضمانت باقی می‌ماند. پس از تحویل در اسرع وقت مبلغ به <span style={{color:"#067fc8"}}> مسافر </span>پرداخت
              می‌شود. بنابراین در صورتی که <span style={{color:"#067fc8"}}> مسافر </span>درخواست خریدی را قبول می‌کند
              باید ابتدا با هزینه شخصی خودش آن خرید را انجام دهد و بعد از تحویل
              هزینه خرید + دستمزد خود را از بیلیگ بگیرد.
            </p>
          </li>
          <h2>مراحلی که <span style={{color:"#067fc8"}}> مسافر </span>باید طی کند</h2>
          <ol>
            <li>ثبت نام در سایت و ثبت سفر:</li>
            <p>
              اولین کار اینه که در سایت ثبت نام کنید. بعد از ثبت نام شما یک عضو
              از بیلیگ هستید. شما زمانی <span style={{color:"#067fc8"}}> مسافر </span>هستید که می‌خواهید به سفر بروید و
              می‌‌تونید به بیلیگرها (آگهی‌دهنده) خدماتی که در بالا ذکر شد ارائه
              بدید. بنابراین شما به‌عنوان <span style={{color:"#067fc8"}}> مسافر </span>باید اطلاعات سفر خودتون رو ثبت
            ...
            <p>
              <span style={{color:"#ff9a00"}}> بیلیگر </span>از این پیشنهاد شما مطلع میشه و می‌تونه پیشنهاد شما رو رد و
              یا قبول کنه. در صورتی که پیشنهادتون رو قبول کنه وارد فاز مذاکره با
              <span style={{color:"#ff9a00"}}> بیلیگر </span>می‌شوید. شما می‌تونید سر قیمت،زمان تحویل، محل قرار و ... با
            ...
            <p>
              ...
              قیمتی رو که <span style={{color:"#ff9a00"}}> بیلیگر </span>بعد از مذاکره به‌عنوان قیمت نهایی ثبت کرده،
              تأیید کنید. بعد از تأیید شما، <span style={{color:"#ff9a00"}}> بیلیگر </span>باید این هزینه رو به پلتفرم
              بیلیگ پرداخت کنه. بعد از پرداخت شما می‌تونید کارتون رو با خیال
              راحت انجام بدید. مثلاً اگر <span style={{color:"#ff9a00"}}> بیلیگر </span>از شما خواسته که براش از مبدأ
              ...
              با خودتون حمل کنید، <span style={{color:"#ff9a00"}}> بیلیگر </span>باید دستمزد شما رو به بیلیگ پرداخت کنه
              و بعد شما شروع به انجام کارتون بکنید.
            </p>
            <li>انجام خدمت:</li>
            <p>
              بعد از توافق با <span style={{color:"#ff9a00"}}> بیلیگر </span>در مذاکره و تأیید پرداخت دستمزدتان، حالا
              باید خدمتی که به شما محول شده رو انجام بدید. مثلاً شما سفرتون از
              کانادا به ایرانه و <span style={{color:"#ff9a00"}}> بیلیگر </span>از شما خواسته که براش از کانادا یه کتاب
            ...
            <p>
              بعد از این که شما این خدمت رو انجام دادید، باید به <span style={{color:"#ff9a00"}}> بیلیگر </span>بگید که
