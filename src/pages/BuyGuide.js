    ...
    <div>
      <Row>
        ...
        >
          ...
          >
            بدون نگرانی از مشکلات حمل‌ونقل و گمرک هرچیزی رو از هرجایی تو دنیا
            احتیاج داشتی، با استفاده از بیلیگ بخر
          </p>
        </Col>
      ...
      >
        <Col>
          ...
          >
            <b>
              خرید کالا از طریق پلتفرم بیلیگ یک فرآیند کاملاً هدایت شده و
              گام‌به‌گام است
              <br />
            </b>
          </p>
      ...
      <Row style={{ backgroundColor: "#EDF2F0" }}>
        ...
        >
          ...
          >
            ...
            شما می‌توانید پس از مذاکره با مسافران مختلف، یک مسافر را برای انجام
            خرید انتخاب کرده و وارد مرحله پرداخت شوید.
          </p>
        </Col>
        <Col xs={1} sm={1} md={1} lg={2} xl={2} xxl={2}></Col>
      </Row>
      ...
      <Row>
        ...
        >
          ...
          >
            در این مرحله شما مبلغ کالای مورد نظر خود را به همراه دستمزد توافق
            شده برای مسافر از طریق گزینه نهایی کردن سفارش پرداخت کرده و منتظر
            خرید توسط مسافر مورد نظر می‌مانید.
          </p>
        </Col>
        <Col xs={1} sm={1} md={1} lg={2} xl={2} xxl={2}></Col>
      </Row>
      ...
      <Row style={{ backgroundColor: "#EDF2F0" }}>
        ...
        >
          ...
          >
            پس از پرداخت به مسافر اطلاع داده می‌شود تا خرید را انجام دهد. صفحه
            چت بین مسافر و شما تا لحظه خرید برای هماهنگی جزئیات خرید فعال
            می‌ماند تا شما از هر جهت نسبت به خرید خود مطمئن باشید و در جریان
            تمامی مراحل خرید قرار بگیرید.
          </p>
        </Col>
        <Col xs={1} sm={1} md={1} lg={2} xl={2} xxl={2}></Col>
      </Row>
      ...
      <Row>
        ...
        >
          ...
          >
            ...
            تحویل خواهد داد. پس از تأیید، هزینه به حساب مسافر واریز خواهد شد. در
            این مرحله می‌توانید از خرید خود لذت ببرید.
          </p>
        </Col>
        <Col xs={1} sm={1} md={1} lg={2} xl={2} xxl={2}></Col>
      </Row>
