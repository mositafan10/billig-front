      ...
      <Row style={{ justifyContent: "center", display: "flex" }}>
        <Col xs={24} sm={24} md={24} lg={12} xl={12}>
          ...
          <li>
            ...
            <p>
              یک نکته مهم در تحویل دادن بسته‌ها مکان قرار گذاشتن
          ...
          <li>
            ...
            <p>
              سیستم امتیازدهی سایت برای بالا بردن اعتمادپذیری کاربران به یکدیگر
              ایجاد شده است. بنابراین توصیه می‌شود حتما از این سیستم استفاده کنید
              تا کاربران از تجربیات شما در مواجهه با کاربران دیگر مطلع
              شوند.
            </p>
          </li>
          {/* <li>
          ...
          <li>
            ...
            <p>
              ...
              فروشنده بگیرید و هنگام تحویل کالا به خریدار تحویل دهید. همچنین
              داشتن رسید، برای ارائه در فرودگاه و گمرک جهت اظهار قیمت ممکن است نیاز شود.
            </p>
          </li>
          <li>
