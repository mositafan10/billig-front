      ...
      <Row style={{ textAlign: "center" }}>
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} xxl={4}>
          <Card
            ...
            bordered={false}
            cover={<img alt="billlig.com" src={add_trip} style={style_icon1} />}
          >
            <h3 style={{ paddingBottom: "5px" }}>مرحله۱: ثبت نام و ثبت سفر</h3>
            <Meta
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} xxl={4}>
          ...
          >
            ...
            <Meta
              ...
              description={
                <div style={travel_guide}>
                  حالا باید باتوجه به نیاز آگهی‌دهنده یا یک بسته رو از صاحب‌بسته
                  تحویل بگیری و با خودت بیاری یا اگه لازم باشه خودت بخریش و
                  بیاریش .
                </div>
              }
            />
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} xxl={4}>
          <Card
            style={{ backgroundColor: "white" }}
            bordered={false}
            cover={<img alt="billlig.com" src={deliverd} style={style_icon1} />}
          >
