      ...
      case "در انتظار پاسخ":
        return type == "billliger" ? (
          <div style={{ textAlign: "justify" }}>
            ...
            <br />
            سعی کنید مذاکرات خود را از طریق محیط چت بیلیگ انجام دهید؛ خوبی این
            ...
            <p>
              <br />
              <b>بیعانه ندهید</b> <br />
              هرگز پیش از دریافت کالا، هزینه‌ای تحت عنوان بیعانه، رزرو
        ...
        return type == "billliger" ? (
          ...
          <div style={{ textAlign: "justify" }}>
            <p>
              ...
              می‌شود و خریدار نیز نباید از این کار ممانعت کند. در ضمن توصیه
            ...
            <p>
              ...
              قیمت هم نیاز ‌باشد. حتی با خریدار توافق کرده‌اید تا بسته را خریده
